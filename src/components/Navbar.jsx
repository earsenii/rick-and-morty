...
import { HomeIcon, MapIcon, FilmIcon } from '@heroicons/react/solid';
      ...
      <div className="w-3/5 flex flex-row justify-between items-center space-x-5">
        ...
        <div className="p-1 w-28 md:w-52 lg:w-60 lg:py-2">
          <input
            ...
            name="name"
            placeholder="Search..."
            className="w-full bg-gray-825 rounded-mg py-2 border-b-2 border-gray-500 text-md lg:text-lg font-semibold outline-none focus:border-white pl-2"
          />
        </div>
      </div>
    </div>
