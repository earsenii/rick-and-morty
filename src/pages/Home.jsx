...
function Home() {
  return (
    <div className="bg-gray-850">
      <div className="min-w-full min-h-screen flex flex-col space-y-3 justify-center items-center lg:flex-row lg:space-x-5 lg:space-y-0 md:space-y-5 sm:flex-col">
        <Link to="/characters">
